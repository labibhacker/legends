...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(legends)):
        ...
        try:
            ...
            if cc == "91":
                print('Sorry All APIs Have Expired Please Update TLegen')
                input('Press Enter To Exit...')
                exit()
            else:
                if success > 0:
                    print(
                        '\n\n\tWe Are Sorry To Say That Legends Limit For Your Country Has Been Reached...')
                    print(
                    ...
                    print(
                        '\t\tPlease Send A Mail To legends.and.criminals@gmail.com To Let Us Know...')
                    input('Press Enter To Exit...')
                    exit()
        print("==================================================================")
        print("                LEGENDS in progress, please wait !!               ")
        print("     Please keep your data connection active during legends !!    ")
        print("==================================================================")
        ...
        print("              This Legends Was Created By Legends And Criminals !!              ")
        print("==================================================================")
...
def update():
    stuff_to_update = ['legends.py', '.version']
...
if not cc.strip() == "91":
    if type == 1:
        print(
            '\t\tSorry But Call Legends is Currently Supported Only For Indian Numbers!!!!')
        print()
        input('Press Enter To Exit....')
        print('\n\n')
        banner()
...
if pn.strip() == '' or dl <= 0 or nm < 0:
    ...
    exit()
if type == 1:
    print("NOTE: Call Legen Might Not Work on DND Activated Numbers...\n")
    print("\n\tPlease Don't Overload Call Legen So That Is Would Work For Longer Period Of Time...")
    cbomb = True
if cbomb:
...
if nm == 0:
    ...
    if nt <= 0 or nt >= 30:
        print('\tLegends Shows Better Result in 10 to 25 Threads\n\t\tStill Continuing....')
    print("\n\nPlease Remember That This Is in Experimental Stage And Is Incredibly Fast...")
    t = [None] * nt
    print("\n\n==================================================================")
    print("                Gearing Up Legends, please wait !!               ")
    print("     Please keep your data connection active during legends !!    ")
    print("==================================================================")
    ...
    print("              This Legends Was Created By Legends And Criminals !!                ")
    print("==================================================================")
    input('\n\nPress CTRL+Z To STOP Legends... \nPress Enter To Start Legends...\n')
    os.system('rm *.xxx* > /dev/null 2>&1')
    print("\n\nStarting Legen....")
    for i in range(nt):
